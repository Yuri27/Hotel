...
<html>
	...
	<body>
		...
		<div class="wrapper">
			...
			<article>
				<div id="about">
					<h1>Здесь Вы найдете подробную информацию о каждой категории номеров</h1>
							...
							<div class="crsl-wrap">
								...
								do{
									echo '<div class="crsl-item">
										<div class="thumbnail">
											<img src="'.$cat['images'].'" alt="nyc subway">
										</div>

											<h3><a href="#">'.$cat['name_category'].'</a></h3>

											<p>';echo file_get_contents($cat['about']);echo'</p>
									</div><!-- post #1 -->';
