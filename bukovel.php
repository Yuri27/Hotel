			...
			<header>
				<form id="top_nav" name="search" action="bron.php" method="GET" onsubmit="myButton.disabled = true; return true;">
					...
					<select class="search" type="text" name="city_name">
							...
							<option selected value="Буковель">Буковель</option>
					</select>
			...
			<article>
				<div id="main">
					<div class="slider">
						<ul>
							<li>
								<img src="img/bukovel/1.jpg" />
								<span>
									<h4>RADISSON BLU RESORT, BUKOVEL</h4>
								</span>
							</li>
							<li>
								<img src="img/bukovel/2.jpg" />
								<span>
									<h4>RADISSON BLU RESORT, BUKOVEL</h4>
								</span>
							</li>
							<li>
								<img src="img/bukovel/3.jpg" />
								<span>
									<h4>RADISSON BLU RESORT, BUKOVEL</h4>
								</span>
							</li>
				...
				<div class="blocks">
						<div class="block1">
							<h1 style="text-align: left; color: #034ea0;">ОТДЫХ В СКАЗОЧНЫХ КАРПАТАХ В ОТЕЛЕ RADISSON BLU RESORT, BUKOVEL</h1>
							<p>Отель Radisson Blu Resort, Bukovel расположен в самом сердце украинских Карпат, на известном горнолыжном курорте Буковель. Комфортное проживание, первоклассный сервис, разнообразие спа-процедур, два бассейна и сауны, непосредственный выход на горные склоны, в частности, на трассу подъемника № 7 обеспечивают 5 ***** отдых в Карпатах зимой и летом.</p>
							<p>252 номера отеля Radisson Blu Resort в Буковеле различной категории оформлены в альпийском стиле и имеют все удобства, включая бесплатный высокоскоростной беспроводной Интернет и спутниковое телевидение. Большинство номеров имеют балконы, с которых открывается сказочный вид Карпат.</p>
							...
							<p id="bla" style="display: none">
								Посетите наши рестораны Montblanc и B-Zone, которые предлагают европейские и украинские блюда. Проведите веселый вечер с друзьями в одном из баров за любимым коктейлем. Насладитесь косметическими и спа-процедурами Spa & Wellness-центра площадью 2000 м.кв. в отеле Radisson Blu Resort, Bukovel.<br>

								<br>Лыжная комната для хранения лыжного оборудования, детская комната с кинозалом, тренажерный зал и большой конференц-зона на 7залов всегда в вашем распоряжении.<br>

								<br>Выберите комфортный отдых в Буковеле зимой или летом в нашем отеле.<br>

								<br>Зимой вас ждут традиционное катание на лыжах, снегоходах, сноубайках, собачьих упряжках. Летом наслаждайтесь удивительными пешими, конными и велосипедными прогулками, а для любителей экстремальной езды есть рафтинг и квадро-туры.</p>
						</div>
						<div class="block2">
							<p style="text-align: left; margin-left: 42px;margin-bottom: -20px;">От<h2 style="text-align: left; margin-left: 42px;">UAH 2,175.00 в./ночь</h2>
							<form action="bron.php" method="GET">
								<input type="hidden" name="city_name" value="Буковель">
						...
						<div class="block3">
							<div id="mini_main">
								<div class="mini_slider">
									<ul>
										<li>
											<img src="img/bukovel/1.png" />
												<p>Сертификат отличия портала</p>
												<p>TripAdvisor</p>
										</li>
										<li>
											<img src="img/bukovel/2.png" />
										</li>
										<li>
											<img src="img/bukovel/3.png" />
